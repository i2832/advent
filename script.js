document.addEventListener('DOMContentLoaded', function() {
    ...
    const events = {
        ...
        26: "Быть первым - это как быть вторым, но первым",
        27: "Жизнь это приключение, - наслаждайся",
        28: "Всегда делай то, - что тебе нравится",
        39: "Жизнь это игра, но без правил и насмерть",
        30: "Завтра будет лучше - чем послезавтра",
